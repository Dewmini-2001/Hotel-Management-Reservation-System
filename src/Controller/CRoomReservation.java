...
public class CRoomReservation {
    ...
    public void ReserveRoom(String reservation_no,String guest_id,String room_no,Date check_in_date,Date check_out_date,int nights,double total_amount,String payment_method)
    {
        MRoomReservation MReserve = new MRoomReservation();
        MReserve.ReserveRoom(reservation_no, guest_id, room_no, guest_id, guest_id, nights, total_amount, payment_method);
    }
